...
@section('content')
<div class="mb-6">
    <h2 class="text-3xl font-bold text-gray-800">Edit Kriteria</h2>
</div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                ...
                <select
                    ...
                    <option value="benefit" {{ old('tipe', $kriterium->tipe) == 'benefit' ? 'selected' : '' }}>Benefit (Semakin tinggi semakin baik)</option>
                    <option value="cost" {{ old('tipe', $kriterium->tipe) == 'cost' ? 'selected' : '' }}>Cost (Semakin rendah semakin baik)</option>
                </select>
                @error('tipe')
                <p class="text-red-500 text-xs italic mt-1">{{ $message }}</p>
                @enderror
